...
```{r}
# Function to calculate Cronbach's alpha for a subscale
calculate_alpha_subscale <- function(data, subscale, n) {
  items_subscale <- function_items_subscale_bfi(subscale, n)
  alpha_result <- psych::alpha(data[, items_subscale, drop = FALSE], na.rm = TRUE, check.keys = TRUE)
  return(alpha_result$total.alpha)
}

# Function to get all columns of one subscale in a vector
function_items_subscale_bfi <- function(subscale, n) {
  items_subscale_bfi <- paste0("bfi_", subscale, 1:n)
}
...
# Print the results
print(paste("Alpha for Agreeableness:", alpha_agreeableness))
print(paste("Alpha for Conscientiousness:", alpha_conscientiousness))
print(paste("Alpha for Extraversion:", alpha_extraversion))
print(paste("Alpha for Neuroticism:", alpha_neuroticism))
print(paste("Alpha for Openness:", alpha_openness))
...
```{r}
h1 <- function(data, subscale, title, xlab) {
