...
ggplot(data_processed_after_exclusions, aes(x = mean_evaluation)) +
  ...
  xlab("Mean Evaluation") +
  ylab("Density") +
  ggtitle("Density plot for mean evaluation")
...
## Self-reported evaluations are correlated with evaluations of the AMP

```{r}

ggplot(data_processed_after_exclusions, aes(x = mean_evaluation, y = AMP_score)) +
  geom_jitter(width = 0.075) +
  geom_smooth(method = "lm", se = FALSE, color = "lightred") +
  xlab("Mean Evaluation") +
  ylab("AMP score") +
  ggtitle("Scatter plot of mean evaluation and AMP score") +
  theme_classic()
